...
require (
	...
	github.com/pawnkit/pawnlint v1.8.38
	github.com/pawnkit/pawnserver v0.7.2
)
...
require (
	...
	github.com/pawnkit/pawn-analysis v0.30.16 // indirect
	github.com/pawnkit/pawn-parser v1.5.11 // indirect
